                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" name="pembayaran_perbulan" id="pembayaran_perbulan" required class="form-control" placeholder="Rp.">
                        </div>
                      </div>
        ...
        <div class="row">
          <?php foreach ($bulan_pembayaran as $dbp): ?>
            <?php 
              ...
              $total_uang_kas_bulan_ini = mysqli_fetch_assoc(mysqli_query($conn, "SELECT sum(kas) as total_uang_kas_bulan_ini FROM uang_kas WHERE id_bulan_pembayaran = '$id_bulan_pembayaran'"));
            ...
            <div class="col-lg-3">
              <div class="card shadow">
                <div class="card-body">
                  ...
                  <h6>Rp. <?= number_format($dbp['pembayaran_perbulan']); ?> / Bulan</h6>
                      ...
                      <form method="post">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              <label for="pembayaran_perbulan<?= $dbp['id_bulan_pembayaran']; ?>">Pembayaran Perbulan</label>
                              <input type="number" name="pembayaran_perbulan" id="pembayaran_perbulan<?= $dbp['id_bulan_pembayaran']; ?>" required class="form-control" placeholder="Rp." value="<?= $dbp['pembayaran_perbulan']; ?>">
                            </div>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-fw fa-times"></i> Close</button>
